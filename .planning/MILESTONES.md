...
## v1.0 Archive Refactor (Shipped: 2026-02-23)
...
## v1.1 Archive Polish (Shipped: 2026-02-24)

**Phases completed:** 2 phases (4-5), 3 plans, 6 tasks
**Timeline:** 2026-02-24 (single day)
**Git range:** 514efbb → 03bb758
...
- Mobile view selector hidden; tap top bar to toggle between slideshow and table views
