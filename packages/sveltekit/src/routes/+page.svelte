...
<svelte:head>
    ...
    <meta
        name="description"
        content="World Affairs is a record label founded and owned by Yung Lean, based in Stockholm, Sweden. Featuring releases from Yung Lean, Bladee, and Jonatan Leandoer96."
    />
    <meta property="og:title" content="World Affairs AB" />
    <meta
        property="og:description"
        content="World Affairs is a record label founded in 2020 by Yung Lean, based in Stockholm, Sweden."
    />
